...
class BubbleTrashLayout extends BubbleBaseLayout {
        ...
        if (attachedToWindow) {
            if (visibility != getVisibility()) {
                if (visibility == VISIBLE) {
                    playAnimation(R.anim.bubble_trash_shown_animator);


                } else {
                    playAnimation(R.anim.bubble_trash_hide_animator);
                }
            }
        }
    ...
    void applyMagnetism() {
        if (!magnetismApplied) {
            ...
            playAnimation(R.anim.bubble_trash_shown_magnetism_animator);
        }
    }
    ...
    void releaseMagnetism() {
        if (magnetismApplied) {
            ...
            playAnimation(R.anim.bubble_trash_hide_magnetism_animator);
        }
