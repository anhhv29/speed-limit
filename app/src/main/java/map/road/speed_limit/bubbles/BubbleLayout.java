...
//                        playAnimationClickUp();
    ...
    private void playAnimation() {
        if (!isInEditMode()) {
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
                    .loadAnimator(getContext(), R.anim.bubble_shown_animator);
    ...
    private void playAnimationClickDown() {
        if (!isInEditMode()) {
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
                    .loadAnimator(getContext(), R.anim.bubble_down_click_animator);
            animator.setTarget(this);
            animator.start();
        }
    }
    ...
    private void playAnimationClickUp() {
        if (!isInEditMode()) {
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
                    .loadAnimator(getContext(), R.anim.bubble_up_click_animator);
            animator.setTarget(this);
            animator.start();
        }
    }
